...
import {getFullFormDate, getUpperCase} from '../util.js';
import {getOfferName, getOfferPrice} from '../mock/data.js';

function createSortTemplate(offers) {
...
function createFormTemplate() {
  ...
  const date = getFullFormDate(dateFrom);
  const offersTemplate = createSortTemplate(offers);
  ...
  return (
    ...
    <header class="event__header">
      ...
      <div class="event__field-group  event__field-group--destination">
        ...
        <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${getDestinationById(destination).name}" list="destination-list-1">
    ...
    <section class="event__details">
      ...
      <section class="event__section  event__section--destination">
        ...
        <p class="event__destination-description">${getDestinationById(destination).description}</p>
        <div class="event__photos-container">
          <div class="event__photos-tape">
          <img class="event__photo" src="${getDestinationById(destination).pictures.src}" alt="Event photo">
          </div>
        </div>
        .pictures.src
      </section>
